        ...
        <section class="py-5">
            <div class="container-xxl g-codecyan overflow-hidden py-5">
                <div class="row justify-content-center align-items-center gap-5 my-4">
                    <div class="col-md-6">
                        <!-- Form Register -->
                        <div class="text-center" data-aos="zoom-out-right" data-aos-duration="1000">
                            <form class="text-start" action="/register" method="post">
                                @csrf
                                <h4 class="fw-bold text-blue text-center mt-1 mb-4">Buat Akun</h4>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="Username" class="form-label">Username</label> <!-- Menghapus kelas "text-start" pada elemen ini -->
                                    <input
                                        type="username"
                                        class="form-control"
                                ...
                                <div class="mb-3">
                                    <label for="password-conf" class="form-label">Konfirmasi Password</label>
                                    <input
                                        type="password-conf"
                                        class="form-control"
                                ...
                                <div class="text-center mt-2 mb-4">
                                    <button type="submit" class="btn btn-accent-codecyan btn-lg mt-3">Daftar</button>
                                </div>
                            </form>
